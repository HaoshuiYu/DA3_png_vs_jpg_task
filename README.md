...
![Provided figure](figures/trajectory.png)
*The assessor's figure: PNG and JPG runs, JPG aligned onto PNG.*

![Our reproduction](figures/pair_png_jpg.png)
*Our reproduction at default settings. Same shape — knot at the start, straight walk — but the two paths sit much closer after alignment.*
...
- Transformations: I realized after taht different transformations would compound noise, the origin and "root cause" which is the intention of this project which should be the central thesis to look for
...
![All six runs aligned to png_1](figures/overlay_aligned.png)
*png_2 sits on png_1; jpgbar_1 sits on jpg_1; noise_1 and noise_2 land in different places.*

![Per-frame error vs png_1](figures/per_frame_error.png)
*Distance from png_1 at every frame. Dotted lines: chunk boundaries. Shaded: frames where the camera barely moved. Error is largest [fill in from what you see].*
